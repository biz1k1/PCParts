...
{
    Task<IEnumerable<Component>> GetComponents(ISpecification<Component> specification, CancellationToken cancellationToken);
    Task<Component> GetComponent(Guid componentId, ISpecification<Component> specification, CancellationToken cancellationToken);
