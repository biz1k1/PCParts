...
public class SpecificationServiceShould
{
    ...
    public async Task ReturnCreatedSpecification()
    {
        ...
        var returnSpecification = _storageSpecification.Setup(x =>
            x.CreateSpecification(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<SpecificationDataType>(),
        ...
        _storageSpecification.Verify(x =>
            x.CreateSpecification(componentId, "spec", SpecificationDataType.STRING, "text", CancellationToken.None), Times.Once);
