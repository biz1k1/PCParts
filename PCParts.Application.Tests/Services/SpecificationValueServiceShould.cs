...
//                    x.CreateSpecificationsValues(TODO, new CreateSpecificationValueCommand(Guid.Empty, null), CancellationToken.None))
...
//        {
//            await _sut.Invoking(x =>
//                    x.CreateSpecificationsValues(TODO, new CreateSpecificationValueCommand(Guid.Empty, Guid.Empty, null), CancellationToken.None))
//                .Should().ThrowAsync<ComponentNotFoundException>();
//        }
